...
const Donna = () => {
  const [messages, setMessages] = useState([
    { type: 'user', text: 'Donna, clear my schedule for today.' },
    { type: 'bot', text: "Done! I've cleared today's schedule." }
  ]);
  ...
  return (
    <div style={containerStyle}>
      ...
      <div style={inputWrapperStyle}>
        ...
        />
        <button onClick={() => alert("Summarizing meetings...")} style={summarizeButtonStyle}>
          Summarize
        </button>
